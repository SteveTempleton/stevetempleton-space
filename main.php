<main>
  ...
  <section class="section is-flex-mobile is-raisin-black has-text-white">
    <div class="container">
      <div class="content has-text-centered">
        <a name="about"></a>
        <div>
          <h3 class="title is-3 has-text-white">About Me</h3>
        </div>
        <h4 class="subtitle is-5 has-text-white">Software Engineer</h4>
        <div class="content">
          <p>Developing solutions and streamlining complex IT systems is my focus. Learning new skills and advancing my
            knowledge base in multiple fields is my passion.</p>
        </div>
      ...
      <div class="content">
        <h4 class="is-4 has-text-weight-bold is-uppercase has-text-white">Technical Skills</h4>
      </div>
      <div class="columns">
        <div class="column">
          <div class="content">

            <p class="has-text-weight-bold">Front End Web Development</p>
            <ul>
          ...
          <div class="content">
            <p class="has-text-weight-bold">Back End Web Development</p>
            <ul>
              <li>PHP</li>
              <li>MySQL</li>
              <li>MariaDB</li>
          ...
          <div class="content">
            <p class="has-text-weight-bold">Application Development</p>
            <ul>
              <li>Java</li>
              <li>C#</li>
        ...
        <div class="column">
          <div class="content">
            <p class="has-text-weight-bold">Professional Skills</p>
            <ul>
              <li>Leadership</li>
              <li>Project Management</li>
            </ul>
            <p class="has-text-weight-bold">Other Technologies</p>
            <ul>
              <li>Git</li>
              <li>Apache: Tapestry | Solr | Cayenne</li>
              <li>SASS</li>
              <li>Python</li>
              <li>React</li>
              <li>Salesforce</li>
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h4 class="is-4 is-uppercase has-text-weight-bold has-text-white">Work Experience</h4>
          </div>

          <div class="content">
            <h5 class="title has-text-white">Executive Producer</h5>
          ...
          <div class="content">
            <h5 class="title has-text-white">Software Engineer</h5>
            <p class="subtitle is-6 has-text-white">Enterprise Application Development</p>
            <p>North Dakota State University | 2020 - Present</p>
            <ul>
              <li>Engineer system for Research Equipment Database housing over 1000 pieces of equipment. The system was
                built using Java, Apache Tapestry and Cayenne.</li>
              <li>Develop updates to the Employment Job List using Angular and TypeScript allowing for potential
          ...
          <div class="content">
            <h5 class="title has-text-white">Information Systems Engineer</h5>
            <p class="subtitle is-6 has-text-white">O'Neill School of Public and Environmental Affairs</p>
            <p class="subtitle is-6 has-text-white">Indiana University | 2017 - 2020</p>
            <ul>
              <li>Engineered a Scholarship application system using HTML, CSS, JavaScript, PHP, MySQL and C#. The system
                is available to over 4,000 students and built to manage the awarding of over 50 unique scholarships.
              </li>
              <li>Managed over 50 websites in a CMS system (Cascade CMS) using HTML, CSS, JavaScript, and PHP.
              </li>
          ...
          <div class="content">
            <h5 class="title has-text-white">Classroom Technology Support Specialist</h5>
            <p class="subtitle is-6 has-text-white">Classroom Technology Services</p>
            <p>Indiana University | 2014 - 2017</p>
            <ul>
              <li>Built the Indiana University Classroom Database to be used by 9 campuses, managed departmental
                intranet web resources, and created web forms using HTML, CSS, JavaScript, PHP, and MySQL.
              </li>
          ...
          <div class="content">
            <h5 class="title has-text-white">Support Advisor</h5>
            <p class="subtitle is-6 has-text-white">University Information Technology Services (UITS)</p>
            <p>Indiana University | 2014 - 2017</p>
            <ul>
              <li>Trained and supervised hourly consultants by coordinating staff during busy call volumes, handling
                customer complaints, and answering consultant's questions.
              </li>
              <li>Utilized team collaboration skills by pooling together knowledge from a team of professionals and
                consultants to find answers to the more difficult problems.</li>
              <li>Guided consultants through complex technical concepts minimizing call times.</li>
            </ul>
          </div>
        </div>
        <!-- Second Column -->
        <div class="column">
          <div class="content">
            ...
            <div class="content">
              <h6 class="title is-6 has-text-white">Informatics (B.S.)</h6>
              <p class="subtitle is-6 has-text-white">Indiana University 2012</p>
            </div>
            <div class="content">
              <h6 class="title is-6 has-text-white">Psychology (B.A.)</h6>
              <p class="subtitle is-6 has-text-white">Indiana University 2012</p>
            </div>
          </div>
          <!-- Other Exp -->
          <h5 class="title is-5 has-text-weight-bold is-uppercase has-text-white">Other Experience</h5>
          <div class="content">
            <h6 class="subtitle is-6 has-text-white is-uppercase">Conferences</h6>
          </div>
          <div class="content">
            <p><span class="is-uppercase">Indy Code() 2020 Accepted</span> (Cancelled...Thanks Covid.)</p>
            <ul>
              <li class="">Developing the Developer 2.0</li>
            </ul>
          </div>
          <div class="content">
            <p class="is-uppercase">Indiana University Statewide IT Conference 2019</p>
            <ul>
              <li class="">Developing the Developer 1.0</li>
            </ul>
          </div>
          <div class="content">
          ...
          <div class="content">
            <p class="is-uppercase">Indiana University Statewide IT Conference 2018</p>
            <ul>
  ...
  <!-- Removing for the moment 
    <section class="section is-raisin-black is-flex-mobile">
      <div class="container">
        <div class="content">
          <a name="projects"></a>
          <h3 class="title is-3 has-text-white">Projects</h3>
          <div class="columns">
            <div class="column">
              <div class="box">
                <div class="media-left">
                  <figure class="image is-96x96">
                    <img src="images/pinky-sm.jpg">
                  </figure>
                </div>
                <div class="media-content">
                  <div class="content">
                    <p>Developing the Developer</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="section has-background-link is-flex-mobile is-medium">
    <div class="container">
      <a name="contact"></a>
